...
context transaction {
    entity purchaseorder : common.Amount, cuid {
        // key NODE_KEY         : common.Guid;
            ...
            PARTNER_GUID     : Association to master.businesspartner @(title: '{i18n>PARTNER_ID}');
    ...
    entity poitems : common.Amount, cuid {
        // key NODE_KEY     : common.Guid;
            ...
            PO_ITEM_POS  : Integer @(title: 'Item');
            PRODUCT_GUID : Association to master.product @(title: 'Product ID');
    }
}
